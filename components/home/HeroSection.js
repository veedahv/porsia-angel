export default function HeroSection() {
  return (
      <section className="">
        ...
        <div className="my-10 md:pt-10 absolute md:relative bottom-[10px] left-0 right-0">
        ...
        <div className="container xl:max-w-screen-xl mx-auto my-10 md:pb-10 px-4 w-full text-center">
